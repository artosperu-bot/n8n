...
export interface CrmRepository{
  ...
  recordInbound(input:{sessionId:string;messageId:string;content:string;contactName?:string|null;waId:string;sourceSentAt?:string|null}):Promise<{mode:CrmAttentionMode;version:number|null;duplicate?:boolean}>;
