...
export class OpenAIProvider implements LlmProvider {
  ...
  async write(input: LlmWriteInput): Promise<LlmResult> {
    ...
    const instructions = [
      ...
      'FAB es una técnica interna: Feature verificable → Advantage segura → Benefit contextual seguro. Si ATTRIBUTE y verifiedFeatures existen, conecta el atributo con un beneficio prudente basado en useCase/problem/priorities/implications; nunca escribas Feature/Advantage/Benefit.',
